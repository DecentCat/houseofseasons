...
namespace Wilberforce
{
    ...
    public class Colorblind : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            isSupported = true;
            Type = PlayerPrefs.GetInt(Constants.COLOUR_MODE_PREF_KEY);
        }
	...
	{	
		...
		private readonly int[] typeInts = new int[5] { 0, 1, 2, 3, 4 };
